...
<div class="lg:flex lg:items-center lg:justify-between">
    <div class="flex-1 min-w-0">
        ...
        <div class="mt-1 flex flex-col sm:flex-row sm:flex-wrap sm:mt-0 sm:space-x-6">
            ...
            <form class="my-2 flex sm:flex-row flex-col">
                <select id="currency" name="field" class="focus:ring-indigo-500 focus:border-indigo-500 h-full py-0 pl-2 pr-7 bg-white text-gray-500 sm:text-sm border-gray-300 border rounded-l-md">
    ...
    <div class="mt-5 flex lg:mt-0 lg:ml-4">
        ...
        <span class="sm:ml-3">
        <a href="<?=base_url("index.php/aplikasi/form")?>" type="button" class="inline-flex items-center px-4 py-2 border border-transparent rounded-md shadow-sm text-sm font-medium text-white bg-indigo-600 hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500">
            <!-- Heroicon name: solid/check -->
            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="-ml-1 mr-2 h-5 w-5 feather feather-user-plus"><path d="M16 21v-2a4 4 0 0 0-4-4H5a4 4 0 0 0-4 4v2"></path><circle cx="8.5" cy="7" r="4"></circle><line x1="20" y1="8" x2="20" y2="14"></line><line x1="23" y1="11" x2="17" y2="11"></line></svg>
            Tambah
        </a>
        </span>
